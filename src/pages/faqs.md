...
<div class="tabs">
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">Who owns Beechwood Swim Club?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">What does it mean to be a bond-holder?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">How does someone become a bond-holder?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">What are the annual dues for a bond-holder?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">Is bond ownership required for all memberships?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">What is the duration of the club’s season, and when must membership dues be paid for the season?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">Will COVID-19 affect the 2021 season?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">Can members bring non-members with them to the swim club?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">As a member, who can I contact with issues or suggestions?</label>
...
<div class="tab">
<input type="radio" id="rd1" name="rd"><label class="tab-label" for="rd1">How do I reserve time slots during the 2021 season?</label>
